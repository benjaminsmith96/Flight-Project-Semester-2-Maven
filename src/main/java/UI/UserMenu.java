...
public class UserMenu extends javax.swing.JFrame {
	...
	public UserMenu(Customer user) throws Exception {
		initComponents();
		this.user = user;
                int points = 0;
                MembershipDBController db = new MembershipDBController();
                points = db.getMembership(user);
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				...
				layout.createSequentialGroup().addContainerGap(95, Short.MAX_VALUE)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(jButton_GenerateCoupon, javax.swing.GroupLayout.PREFERRED_SIZE, 312,
										javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(45, 45, 45)
						...
						.addComponent(jButton_GenerateCoupon, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
								javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	private void jButton_GenerateCouponActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			Logger.getLogger(UserMenu.class.getName()).log(Level.SEVERE, null, ex);
                ...
                CouponGenerator generator = new CouponGenerator(this.user);
