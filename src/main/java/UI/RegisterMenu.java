...
public class RegisterMenu extends javax.swing.JFrame {
    ...
    private void jButton_RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegisterActionPerformed
        ...
        String phoneNumber = jTextField_MobileNumber.getText();
        ...
        RegisterFacade reg = new RegisterFacade(firstName, lastName, email, password, phoneNumber, dateOfBirth, gender);
        try {
            reg.register();
        } catch (Exception ex) {
